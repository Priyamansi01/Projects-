...
<html lang="en">
  ...
  <body>
    ...
    <form action="downloadPrescription.php" method="post">
        <div class="container my-2 input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1">E-mail: </span>
            </div>
            <input name="mailn" type="text" class="form-control" placeholder="Mail Id" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        <div class="container">
